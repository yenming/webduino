...
Blockly.Blocks['table_get'] = {
  ...
  this.appendDummyInput()  
      ...
      .appendField(new Blockly.FieldDropdown([["rows","rows"], ["columns","columns"], ["left","left"], ["top","top"], ["borderstyle","borderstyle"], ["borderwidth","borderwidth"], ["bordercolor","bordercolor"], ["zindex","zindex"], ["display","display"]]), "property_");
  this.setInputsInline(true);
